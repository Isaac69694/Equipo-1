...
def consultarPaqueteria():
    return render_template('paqueteria/consulta.html')

@app.route('/paqueteria/editar')
def editarPaqueteria():
    return render_template('paqueteria/modificar.html')

@app.route('/paqueteria/agregar')
def agregarPaqueteria():
    return render_template('paqueteria/agregar.html')

@app.route('/paqueteria/eliminar')
def eliminarPaqueteria():
    return render_template('paqueteria/eliminar.html')
